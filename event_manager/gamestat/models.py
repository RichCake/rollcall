...
class GameStat(models.Model):
    ...
    def create_or_update(
        ...
        game_stat.top_5_hours = [
            {"name": game.name, "url": game.url, "playtime": game.playtime} for game in top_5_hours
        ]
        game_stat.top_5_last_2weeks = [
            {"name": game.name, "url": game.url, "playtime": game.playtime} for game in top_5_last_2weeks
        ]
